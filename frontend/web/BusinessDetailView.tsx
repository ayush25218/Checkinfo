          ...
          <div className="business-hero-content-row">
            <div className="business-hero-text">
              <div className="business-hero-badges">
                <span className="detail-badge badge-verified">✔ GST Verified</span>
                <span className="detail-badge badge-response">⚡ Quick Response</span>
                <span className="detail-badge badge-rating">⭐ 4.8 / 5.0 (48 Reviews)</span>
          ...
          <section className="detail-section-card">
            ...
            <div className="detail-info-grid">
              ...
              <div className="info-item">
                ...
                <strong className="info-value">Mon - Sat: 9:00 AM - 7:00 PM</strong>
              </div>
              <div className="info-item">
                <span className="info-label">Verification Status</span>
                <strong className="info-value text-green">✔ 100% GST & Address Verified</strong>
              </div>
            </div>
          </section>
