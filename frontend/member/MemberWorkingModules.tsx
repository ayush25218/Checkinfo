...
export function MyBusinessListingModule() {
  ...
  const isApproved = currentListing.status === "Active" || currentListing.status === "Featured" || currentListing.status === "Popular" || currentListing.approvalStatus === "Approved";
  ...
  return (
    <MemberShell active="My Business Listing">
      <AccountHeader
        ...
        subtitle={isApproved ? "Your business listing is approved and live. Modifications are currently locked." : "View your business listing details. Click the Edit button to modify details."}
