                                ...
                                <div class="nav-menu">
                                    ...
                                    <nav class="main-menu">
                                        <ul>
                                            ...
                                            <li class="menu-item has-children"><a href="#" class="active">Pages</a>
                                                <ul class="sub-menu">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form_group file-input-one">
                                            ...
                                            <div class="upload-content">
												<div class="upload-title-icon d-flex align-items-center justify-content-center">
                                                    <img src="/fioxen/assets/images/elements/input-1.png" alt="Image">
												</div>
											</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form_group file-input-two">
                                            ...
                                            <div class="upload-content">
												<div class="upload-title-icon d-flex align-items-center justify-content-center">
                                                    <img src="/fioxen/assets/images/elements/input-2.png" alt="Image">
                                                    <span>Add Video +</span>
												</div>
											</div>
                                        </div>
                                        <div class="form_group file-input-two">
                                            ...
                                            <div class="upload-content">
												<div class="upload-title-icon d-flex align-items-center justify-content-center">
                                                    <img src="/fioxen/assets/images/elements/input-3.png" alt="Image">
                                                    <span>Add Video +</span>
												</div>
											</div>
                                        </div>
